    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RatedArtworks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RatedArtworks_Artworks_ArtworkId",
                        column: x => x.ArtworkId,
                        principalTable: "Artworks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RatedArtworks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikedReviews", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LikedReviews_UserId",
                table: "LikedReviews",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RatedArtworks_ArtworkId",
                table: "RatedArtworks",
                column: "ArtworkId");

            migrationBuilder.CreateIndex(
                name: "IX_RatedArtworks_UserId",
                table: "RatedArtworks",
                column: "UserId");
